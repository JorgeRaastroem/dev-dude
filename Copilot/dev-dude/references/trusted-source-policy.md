...
Copilot agents, web and research tools cannot be technically locked to specific domains — source
restriction is a prompt/behavioral policy. The single enforceable rule is the **citation-host
