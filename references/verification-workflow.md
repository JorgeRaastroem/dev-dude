...
- Use `mcp__serena__find_file("<filename>", "<directory>")` or `mcp__serena__list_dir("<path>", recursive=false)`
...
- Use `mcp__serena__find_symbol("<name>", relative_path="<stated-path>")` with `include_body=false`
...
- Use `mcp__serena__find_symbol("<name>", relative_path="<path>", include_body=true)`
...
- Use `mcp__serena__find_referencing_symbols("<name>", relative_path="<path>")`
...
- Use `mcp__serena__search_for_pattern("<pattern>")` to find evidence
